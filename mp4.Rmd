...
In recent years, the percentage of good horror movies keeps increasing, which means that horror movies are actually getting better reviews. And the recent two horror films, *It* and *Get Out*, are two vivid examples of elegant horror movies as they have gained amazingly good critical reviews. Their success rebuts those critics’ negative expectations about horror movies and implies the bright future of the performance of horror movies. 


<br>

To sum up, as both the quantity and quality of horror movies increase, horror movies are welcoming a splendid future. Nevertheless, we have to say, the real situation will depend on the thoughts people have towards horror movies. Therefore, a survey about people’s real impression of horror is necessary, before we can make an assertion about the future of  horror movies.[^2]
